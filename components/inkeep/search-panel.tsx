      ...
      <Presence present={open}>
        <div
          className={cn(
            ...
            'max-wide:fixed max-wide:inset-x-4 max-wide:bottom-8 max-wide:top-8 max-wide:border max-wide:border-line-structure max-wide:shadow-xl max-wide:max-w-[600px] max-wide:mx-auto',
