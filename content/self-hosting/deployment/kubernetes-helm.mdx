...
For the full README and detailed deployment instructions, please refer to the [langfuse/langfuse-k8s](https://github.com/langfuse/langfuse-k8s) GitHub repository.
...
import { SelfHostFeatures } from "@/components-mdx/SelfHostFeatures";
