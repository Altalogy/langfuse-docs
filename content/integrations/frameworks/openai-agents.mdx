...
![Example trace in Langfuse](/images/cookbook/integration_openai-agents/openai-agent-example-trace.png)
...
![Example trace in Langfuse](/images/cookbook/integration_openai-agents/openai-agent-example-trace-handoff.png)
...
![Example trace in Langfuse](/images/cookbook/integration_openai-agents/openai-agent-example-trace-function.png)
...
![Example trace in Langfuse](/images/cookbook/integration_openai-agents/openai-agent-example-trace-grouped.png)
