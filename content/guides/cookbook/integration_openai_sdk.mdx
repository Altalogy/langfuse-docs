...
![Chat completion](/images/docs/multi-modal-trace.png)
...
![Chat completion](/images/docs/openai-chat.png)
...
![Function](/images/docs/openai-function.png)
...
![Trace with multiple OpenAI calls](/images/docs/openai-trace-grouped.png)
