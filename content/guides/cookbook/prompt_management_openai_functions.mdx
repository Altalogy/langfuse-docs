...
![Langfuse Prompt Management](/images/docs/prompt-management-with-config-for-openai-functions.png)
...
![Trace of OpenAI functions in Langfuse](/images/docs/openai-functions-trace-with-prompt-management.png)
