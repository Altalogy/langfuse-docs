...
![Example trace in Langfuse](/images/cookbook/example-langgraph-evaluation/first-example-trace.png)
...
![Trace tree in Langfuse](/images/cookbook/example-langgraph-evaluation/trace-tree.png)
...
![Costs](/images/cookbook/example-langgraph-evaluation/gpt-4o-costs.png)
...
![Latency](/images/cookbook/example-langgraph-evaluation/agent-latency.png)
...
![User feedback is being captured in Langfuse](/images/cookbook/example-langgraph-evaluation/user-feedback.png)
...
![LLM-as-a-Judge Evaluation Score](/images/cookbook/example-langgraph-evaluation/llm-as-a-judge-score.png)
...
![Dataset items in Langfuse](/images/cookbook/example-langgraph-evaluation/example-dataset.png)
...
![Dataset run overview](/images/cookbook/example-langgraph-evaluation/dataset_runs.png)
![Dataset run comparison](/images/cookbook/example-langgraph-evaluation/dataset-run-comparison.png)
