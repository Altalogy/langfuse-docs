...
![Created prompt in Langfuse UI](/images/docs/prompt-management-langchain-prompt.png)
...
![Trace of prompt used in Langchain in Langfuse](/images/docs/prompt-management-langchain-trace.png)
