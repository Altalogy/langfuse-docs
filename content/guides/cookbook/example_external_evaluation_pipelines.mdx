...
![Trace with RAGAS scores](/images/cookbook/example-external-evaluation-pipelines/traces.png)
...
![Trace with RAGAS scores](/images/cookbook/example-external-evaluation-pipelines/scored-traces.png)
