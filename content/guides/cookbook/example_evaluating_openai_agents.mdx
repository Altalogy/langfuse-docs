...
<div style={{position: "relative", paddingTop: "69.85769728331177%"}}>
  <iframe
    ...
    loading="lazy"
    style={{border: "white", position: "absolute", top: "0", left: "0", height: "100%", width: "100%", borderRadius: "10px"}}
...
![Example trace in Langfuse](/images/cookbook/integration_openai-agents/first-example-trace.png)
...
![Trace tree in Langfuse](/images/cookbook/integration_openai-agents/trace-tree.png)
...
![Costs](/images/cookbook/integration_openai-agents/gpt-4o-costs.png)
...
![Latency](/images/cookbook/integration_openai-agents/openai-agent-latency.png)
...
![Example trace in Langfuse](/images/cookbook/integration_openai-agents/openai-agent-sdk-custom-attributes.png)
...
![User feedback is being captured in Langfuse](/images/cookbook/integration_openai-agents/open-ai-agent-user-feedback.png)
...
![LLM-as-a-Judge Evaluation Template](/images/cookbook/integration_openai-agents/evaluator-template.png)
![LLM-as-a-Judge Evaluator](/images/cookbook/integration_openai-agents/evaluator.png)
...
![LLM-as-a-Judge Evaluation Score](/images/cookbook/integration_openai-agents/llm-as-a-judge-score.png)

#### 6. Observability Metrics Overview

All of these metrics can be visualized together in dashboards. This enables you to quickly see how your agent performs across many sessions and helps you to track quality metrics over time.

![Observability metrics overview](/images/cookbook/integration_openai-agents/dashboard-dark.png)
...
![Dataset items in Langfuse](/images/cookbook/integration_openai-agents/example-dataset.png)
...
![Dataset run overview](/images/cookbook/integration_openai-agents/dataset_runs.png)
![Dataset run comparison](/images/cookbook/integration_openai-agents/dataset-run-comparison.png)
