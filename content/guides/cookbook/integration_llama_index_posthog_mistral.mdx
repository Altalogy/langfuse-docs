...
![Example trace in the Langfuse UI](/images/cookbook/example-posthog-llamaindex-mistral/trace-posthog-llamaindex-miostral.png)
...
![Posthog Dashboard showing user feedback and number of traces](/images/cookbook/example-posthog-llamaindex-mistral/dashboard-posthog-1.png)

![Posthog Dashboard showing latency and costs](/images/cookbook/example-posthog-llamaindex-mistral/dashboard-posthog-2.png)
