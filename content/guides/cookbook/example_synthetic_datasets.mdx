...
![OpenAI Dataset](/images/cookbook/example-synthetic-datasets/openai-dataset.png)
...
![RAGAS Dataset](/images/cookbook/example-synthetic-datasets/ragas-dataset.png)
...
![Dataset in Langfuse](/images/cookbook/example-synthetic-datasets/deepeval-dataset.png)
...
![Hugging Face Dataset Generator](/images/cookbook/example-synthetic-datasets/hf-generator.png)

![Hugging Face Synthetic Dataset](/images/cookbook/example-synthetic-datasets/hf-dataset.png)
...
![Custom RAG Dataset](/images/cookbook/example-synthetic-datasets/custom-rag-dataset.png)
