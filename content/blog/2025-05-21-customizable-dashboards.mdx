...
<Cards>
  ...
  <Card title="Quickstart" href="/docs/get-started" icon={<FileCode />} />
  <Card title="Interactive Demo" href="/docs/demo" icon={<Joystick />} />
  <Card title="About Us" href="/about" icon={<Users />} />
</Cards>
